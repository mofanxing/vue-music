...
export function getRecommend () {
  // 线上环境地址
  const url = debug ? '/api/getTopBanner' : 'http://47.106.210.209/music/api/getTopBanner'
...
export function getDiscList () {
  // 线上环境地址
  const url = debug ? '/api/getDiscList' : 'http://47.106.210.209/music/api/getDiscList'
...
export function getSongList (disstid) {
  const url = debug ? '/api/getCdInfo' : 'http://47.106.210.209/music/api/getCdInfo'
